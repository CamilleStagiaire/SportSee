...
const UserActivity = ({ data }) => {
  ...
  return (
    <div className="dashboard-barChart">
      <h3 className="bar-title">Activité quotidienne</h3>
      <BarChart width={835} height={320} data={data} barGap={8} barCategoryGap={1} style={{ backgroundColor: COLORS.BARCHART_BG }} margin={{ top: 20, left: 50, bottom:20, right:50 }}>
